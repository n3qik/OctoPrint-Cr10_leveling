...
class Cr10_levelingPlugin(octoprint.plugin.AssetPlugin,
    ...
    def get_settings_defaults(self):
        return dict(bed_temp=50, nozzle_temp=170, play_tune=True,
                    wait_for_heat=True,
                    front_left_x=25, front_left_y=15,
                    front_center_x=165, front_center_y=15,
                    front_right_x=315, front_right_y=15,
                    back_left_x=25, back_left_y=310,
                    back_center_x=165, back_center_y=310,
                    back_right_x=315, back_right_y=310,
                    center_x=150, center_y=150,
                    lower_z=0, upper_z=10,
