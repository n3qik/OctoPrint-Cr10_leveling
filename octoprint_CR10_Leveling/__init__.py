...
class Cr10_levelingPlugin(octoprint.plugin.AssetPlugin,
    ...
    def get_settings_defaults(self):
        return dict(bed_temp=50, nozzle_temp=170, play_tune=True,
                    wait_for_heat=True,
                    front_left_x=30, front_left_y=30,
                    front_center_x=120, front_center_y=30,
                    front_right_x=270, front_right_y=30,
                    back_left_x=30, back_left_y=270,
                    back_center_x=120, back_center_y=270,
                    back_right_x=270, back_right_y=270,
